...
namespace Baker_Point.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                int user = getCurrentUser(model.UserName);
        ...
        public ActionResult Manage(ManageMessageId? message,int scroll=0)
        {
            ...
            Response.Write("<script>var scrolla="+scroll+";</script>");
            return View();
        }
